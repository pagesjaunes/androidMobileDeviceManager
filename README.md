...
Android app available from [Google Play](https://play.google.com/store/apps/details?id=fr.pagesjaunes.mdm).

Please see the [issues](https://github.fr.pagesjaunes.mdm/fr-pagesjaunes-mdm/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about mdm_DT? Ask away on the [fr-pagesjaunes-mdm discussion forum](https://groups.google.com/forum/#!forum/fr-pagesjaunes-mdm).

<a href="https://play.google.com/store/apps/details?id=fr.pagesjaunes.mdm" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __fr.pagesjaunes.mdm__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____fr.pagesjaunes.mdm__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.fr.pagesjaunes.mdm.R__) will now be renamed
...
signed with a different key.  Manually uninstall mdm_DT from your device and
...
mdm_DT is a result of a template project I've developed over the years as well as
...
mdm_DT is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.fr.pagesjaunes.mdm/fr-pagesjaunes-mdm/contributors) on
...
[pull requests](https://github.fr.pagesjaunes.mdm/fr-pagesjaunes-mdm/pulls).
